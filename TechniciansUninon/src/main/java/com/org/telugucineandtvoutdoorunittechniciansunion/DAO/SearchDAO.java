...
public class SearchDAO
{
  ...
  public String search(HttpServletRequest request, Map<String, Object> model) { return "search"; }
        ...
        if (!"UPDATE_MEMBER_DETAILS".equalsIgnoreCase(pageId)) {
          ...
          if (topPanelResultCode != null && !"".equalsIgnoreCase(topPanelResultCode))
          {
            if (topPanelResultCode.equalsIgnoreCase("200") || topPanelResultCode.equalsIgnoreCase("300")) {
              ...
              JSONObject obj = this.utils.requestParamsToJSON(request);
  ...
  public String getDetialsByPageId(JSONObject items) {
    ...
    table = String.valueOf(table) + "<thead><tr><th>DATE</th><th>NAME</th><th>FATHER NAME</th><th>DEPT ID</th><th>CARD NO</th><th>AMOUNT</th><th>Update</th><th>Delete</th></tr></thead>";
    ...
    try {
      ...
      if ("CARD_BALANCE_PAYMENT".equalsIgnoreCase(pageId)) {
        colCount = 7;
        theadStr = String.valueOf(theadStr) + "<th align='left'>Paid Amt</th><th align='left'>Reciept No</th><th align='left'>Date of Payment</th><th align='left'>Remarks</th><th align='left'>Update</th><th align='left'>Delete</th>";


        
        query = String.valueOf(query) + " MembershipPayments where membershipPaymentsPK.memberId=:memberId order by paidDate ";
      } else if ("PAY_SUBSCRIPTION_AMOUNT".equalsIgnoreCase(pageId) || 
        "GET_SCUBSRIPTION_DETAILS".equalsIgnoreCase(pageId)) {
        
        colCount = 10;
        theadStr = String.valueOf(theadStr) + "<th align='left'>Description</th><th align='left'>Subscriptoin Amt</th><th align='left'>Paid Amt</th><th align='left'>Receipt No</th><th align='left'>Year</th><th align='left'>Status</th><th align='left'>Paid Date</th>";


        
        theadStr = String.valueOf(theadStr) + "<th align='left'>Update</th><th align='left'>Delete</th>";
        query = String.valueOf(query) + " SubscriptionPayments where memberId=:memberId and category='SUBSCRIPTION' order by paidDate ";
      }
      else if ("LOAN_PAYMENT".equalsIgnoreCase(pageId) || "LOAN_SUMMARY".equalsIgnoreCase(pageId)) {

        
        colCount = 8;
        theadStr = String.valueOf(theadStr) + "<th align='left'>Receipt No</th><th align='left'>Date of Payment</th><th align='left'>Paid Amount</th><th align='left'>Particulars</th><th>Update</th><th>Delete</th>";
        ...
        if (str != null && !"".equalsIgnoreCase(str)) {
          ...
          if (lonDetilsResultcode != null && !"".equalsIgnoreCase(lonDetilsResultcode))
          {
            ...
            {
              tbody = String.valueOf(tbody) + "<tr><td colspan='" + colCount + "' align='center'> No data found !</td></tr>";
              ...
              resultObj.put("DATA_DETAILS", String.valueOf(theadStr) + tbody + "</table>");
            }
            else if (lonDetilsResultcode.equalsIgnoreCase("400"))
            {
              ...
              if (loanDetailsArr != null && loanDetailsArr.size() > 0) {
                table = String.valueOf(table) + "<tbody>";
                for (int i = 0; i < loanDetailsArr.size(); i++) {
                  ...
                  table = String.valueOf(table) + "<td align='left'><form action='updateLoanSanctionDetailsForm' method='POST'  ><input type='hidden' name='update_LoanSanctionDetails_memberId' id='del_LoanSancitonDetails_memberId' value='" + 
                  ...
                  table = String.valueOf(table) + "<td align='left'><form action='deleteLoanSanctionDetailsForm' method='POST'  ><input type='hidden' name='update_LoanSanctionDetails_memberId' id='del_LoanSancitonDetails_memberId' value='" + 
                ...
                table = String.valueOf(table) + "<tbody><tr><td colspan='6' align='center'> No Data found</td></tr></tbody>";
              } 
              ...
              if (jsnArry != null && jsnArry.size() > 0) {
                ...
                for (int i = 0; i < jsnArry.size(); i++) {
                  ...
                  tbody = String.valueOf(tbody) + "<tr><td>" + (i + 1) + "</td>";


                  
                  tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(jsnObj.get("RECEIPT_NO")) + "</td>";
                  tbody = String.valueOf(tbody) + "<td>" + (String)jsnObj.get("PAID_DATE") + "</td>";
                  tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(jsnObj.get("PAID_AMOUNT")) + "</td>";


                  
                  tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(jsnObj.get("REMARKS")) + "</td>";

                  
                  tbody = String.valueOf(tbody) + "<td align='left'><form action='updateLoanRecoveryDetailsForm' method='POST'  ><input type='hidden' name='update_LoanRecoveryDetails_memberId' id='upd_LoanRecoveryDetails_memberId' value='" + 
                  ...
                  tbody = String.valueOf(tbody) + "<td align='left'><form action='deleteLoanRecoveryDetailsForm' method='POST'  ><input type='hidden' name='delete_LoanRecoveryDetails_memberId' id='del_LoanRecoveryDetails_memberId' value='" + 
                ...
                table = String.valueOf(table) + "<table border='1' cellspacing='0' cellpadding='5' style='border-color: #EEE'>";
                table = String.valueOf(table) + "<thead><tr><th>TOTAL LOAN AMOUNT</th><th>TOTAL PAID AMOUNT</th><th>BALANCE</th></tr></thead>";
                table = String.valueOf(table) + "<tbody><tr><td align='center'>" + totalLoanAmount + "</td><td align='center'>" + totalPaidAmount + "</td><td align='center'>" + (totalLoanAmount - totalPaidAmount) + "</td></tr></tbody></table>";
                
                resultObj.put("DATA_DETAILS1", table);
              } else {
                
                tbody = String.valueOf(tbody) + "<tr><td colspan='" + (colCount + 2) + 
          ...
          resultObj.put("OTHER_PANEL_ERROR_MSG", "No data found !");
          resultObj.put("DATA_DETAILS", String.valueOf(theadStr) + tbody + "</table>");
          table = String.valueOf(table) + "<tbody><tr><td colspan='6' align='center'> No Data found</td></tr></tbody></table>";
          resultObj.put("DATA_DETAILS1", table);
        } 
      } 
        ...
        if (list != null && list.size() > 0) {
          ...
          for (int j = 0; j < list.size(); j++) {
            ...
            if (pageId.equalsIgnoreCase("CARD_BALANCE_PAYMENT")) {
              ...
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(Integer.valueOf(membershipPayments.getPaidAmount())) + 
                "</td>";
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(membershipPayments.getReceiptNo()) + 
                "</td>";
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(
                  dateFormater.format(membershipPayments.getPaidDate())) + "</td>";
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(membershipPayments.getRemarks()) + "</td>";
              tbody = String.valueOf(tbody) + "<td align='left'><form action='updateCardBalanceForm' method='POST'  ><input type='hidden' name='update_cardBalance_memberId' id='upd_cardBalance_memberId' value='" + 
              ...
              tbody = String.valueOf(tbody) + "<td align='left'><form action='deleteCardBalanceForm' method='POST'  ><input type='hidden' name='delete_cardBalance_memberId' id='del_cardBalance_memberId' value='" + 
              ...
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(subscriptionStringFormat) + "</td>";
              ...
              tbody = String.valueOf(tbody) + "<td>" + 
                ...
                "</td>";
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(subscriptionPayments.getPaymentStatus()) + 
                "</td>";
              tbody = String.valueOf(tbody) + "<td>" + this.utils.convertNullToEmptyString(
                  dateFormater.format(subscriptionPayments.getPaidDate())) + "</td>";
              
              tbody = String.valueOf(tbody) + "<td align='left'><form action='updateSubcriptionsForm' method='POST'  ><input type='hidden' name='update_subscription_memberId' id='upd_subscrib_memberId' value='" + 
              ...
              tbody = String.valueOf(tbody) + "<td align='left'><form action='deleteSubcriptionsForm' method='POST'  ><input type='hidden' name='delete_subscription_memberId' id='del_subscrib_memberId' value='" + 
      ...
      tbody = String.valueOf(tbody) + "<tr><td colspan='" + colCount + "' align='center'>Unable to fetch records!</td></tr>";
      tbody = String.valueOf(tbody) + "</tbody>";
      resultObj.put("DATA_DETAILS", String.valueOf(theadStr) + tbody + "</table>");
    } 
